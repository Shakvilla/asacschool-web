...
import CardRing from '../../images/card-ring.svg'
...
function PurchaseButton({ title, subtitle }) {
    return (
        <Link to="/page-2">
            <Wrapper>
                <IconWrapper>
                    <Icon src={card} alt="asacschool-payment" className="icon" />
                    <Ring src={CardRing} />
                </IconWrapper>
                <TextWrapper>
...
const IconWrapper = styled.div`
    width: 45px;
    height: 45px;
    background: linear-gradient(200.44deg, #4316db 13.57%, #9076e7 98.30%);
    border-radius: 50%;
    display: grid;
